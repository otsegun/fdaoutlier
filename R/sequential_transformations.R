...
#' are supported including vertical alighnment ("T1(X)(t)"), normalization ("T2"),
#' one order of differencing ("D1" and "D2") and point-wise outlyingness data ("O"). The feature alignment
