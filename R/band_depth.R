...
#'
#'This function computes the band depth of López-Pintado and Romo (2009) \href{https://doi.org/10.1198/jasa.2009.0108}{<doi:10.1198/jasa.2009.0108>}.
#' Bands of 2 functions are always considered using fast algorithm of Sun et al. (2012)
