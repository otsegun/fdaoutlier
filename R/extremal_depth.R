...
#' \eqn{g} with respect to a set of function \eqn{S} denoted by \eqn{ED(s, S)} is the proportion
...
#' penalizes functions that are outliers even for a small part of the domain. See Narisetty and Nair (2016) for
#' details.#'
#'
