...
or the lastest the development version from [GitHub](https://github.com/) with:
...
Kindly open an issue using [Github issues](https://github.com/moviedo5/fdaoutlier/issues).
